...
var StepOne = React.createClass({
   ...
   getInitialState: function() {
    ...
    handleUsernameChange: function(e) {
        ...
        this.props.actions.usernameUpdate(newValue)
    },

    handlePasswordChange: function(e) {
        var newValue = e.target.value
        this.props.actions.passwordUpdate(newValue)
    },

    handleConfirmChange: function(e) {
        var newValue = e.target.value
        this.props.actions.confirmUpdate(newValue)
    },
